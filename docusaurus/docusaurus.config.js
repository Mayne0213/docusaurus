...
const config = {
  ...
  url: 'https://docs.lumie-infra.com',
  ...
  organizationName: 'Lumie-Edu', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/Lumie-Edu/lumie-document/tree/main/docusaurus/',
        },
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/Lumie-Edu/lumie-document',
            label: 'GitHub',
            position: 'right',
          },
        ],
